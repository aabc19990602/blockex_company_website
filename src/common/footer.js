            ...
            <div className="container mt-5 mb-5">
                <div className="row">
                    <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        ...
                        <p className="text-white" style={{ fontSize: "14px" }}><span className="fw-medium">Power your future with BlocEx.</span><br />
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 text-center borderLeft">
                        <h3 className="text-white mb-4" style={{ fontSize: "20px" }}>Join the BlocEx community</h3>
