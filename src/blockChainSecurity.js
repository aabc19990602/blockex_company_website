        ...
        <div className="row justify-content-center">
            ...
            >
              <div className="blockChain_box card">
                ...
                <div>
                  ...
                  <p className="mt-2 px-3 text-white">
                    World Best Secure Crypto Exchange
                  </p>
                </div>
              </div>
            </a>
          ...
          {[
            ...
            },
            {
              ...
              description:
                "Exchange ensures the security of your funds while providing a seamless trading experience",
              image: "/assets/images/Decentralized_Exchange_banner.jpg",
            },
            {
              title: "Crypto Master Card",
              description:
                "Unlock the Future: Spend Anywhere with Master Crypto Card.",
