    ...
    return (
        <>
            ...
            <section className='roadMapBg'>
                ...
                <h1 className='text-center roadmaph1' style={{ color: "#00F0FF" }}>Roadmap</h1>
                <p className='text-white text-center roadmapp1'>2025-2026: Building the Future, Quarter by Quarter</p>
                <div className="timeline">
                    <div className="container-timeline left">
                        <div className="content">
                            ...
                            <ul>
                                ...
                                <li >Create Blockchain (testnet)
                                </li>
                                <li>Create All Social Media Accounts
                                </li>
                                <li >Initial Offering
                                </li>
                                <li >Create All Social Media Accounts
                    ...
                    <div className="container-timeline right">
                        <div className="content">
                            ...
                            <ul>
                                <li>Start Development on Centralized Exchange
                                </li>
                                <li>Listing Our Coin with Exchange
                                </li>
                    ...
                    <div className="container-timeline left">
                        <div className="content">
                            <h2 style={{ color: "#00F0FF" }}>2026 - QUARTER 1
                            </h2>
                            <ul>
                                <li>BlockEx DEX Launch
                                </li>
                                <li>BlockEx Centralized Exchange Launch
                                </li>
                                <li>Listing Coin in More exchanges
                                </li>
                    ...
                    <div className="container-timeline right">
                        <div className="content">
                            ...
                            <ul>
                                <li>BlockEx Mastercard Launch
                                </li>
                                <li>BlockEx Card Platform Launch
                                </li>
                    ...
                    <div className="container-timeline left">
                        <div className="content">
                            <h2 style={{ color: "#00F0FF" }}>2026 - QUARTER 3
                            </h2>
                            <ul>
                                <li>Crypto Payment Gateway

                                </li>
                                <li>Listing BlockEx coin in more Top exchange
                                </li>
                ...
                <section className="contactus" style={{ marginTop: 250 + 'px' }}>
                    <section style={{ backgroundImage: 'linear-gradient(to left, #00F0FF, #00C4F4)' }}>
                        <div className="container">
                            <div className="position-relative" style={{ paddingTop: 70 + 'px', paddingBottom: 70 + 'px' }}>
                                <div className="d-flex flex-wrap">
                                    <div className="part1">
                                        <h1 style={{ color: "#000" }}>$500,000 Raised</h1>
                                        <p style={{ color: "rgba(10, 11, 13, 0.6)" }}>Join the BlockEx crypto presale, engage with the project,<br /> and see your contribution grow to new heights.</p>
                                        {/* <button className='btn buyBtn'>Buy Now</button> */}
                                        <button className='btn howToBuy text-white' style={{ background: "#000" , borderColor:"none"}}>How to Buy?</button>
                                    </div>
                                    <div className='part2'>
                                        <img src='/assets/images/contact_coin.png' className='img-fluid setImgPosition'  alt=''/>
                                    </div>
                                </div>
                            </div>
                        </div>
